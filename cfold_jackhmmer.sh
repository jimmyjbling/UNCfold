...
hhblits_binary_path="$current_working_dir/uncfold-conda/bin/hhblits"
hhsearch_binary_path="$current_working_dir/uncfold-conda/bin/hhsearch"
jackhmmer_binary_path="$current_working_dir/uncfold-conda/bin/jackhmmer"
kalign_binary_path="$current_working_dir/uncfold-conda//bin/kalign"
