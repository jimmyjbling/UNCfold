...
if args.output_dir is None:
    output_dir = 'prediction_' + jobname + '_' + mmseqs2.get_hash(sequence)[:5]
...
a3m_lines, template_paths = mmseqs2.run_mmseqs2(sequence, jobname, True, use_templates=args.template)
